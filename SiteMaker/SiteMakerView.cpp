...
BEGIN_DHTMLEDITING_CMDMAP(CSiteMakerView)
	...
	DHTMLEDITING_CMD_ENTRY_FUNC(ID_COLOR_FORE, IDM_FORECOLOR, &OnColorCommand)
	DHTMLEDITING_CMD_ENTRY_FUNC(ID_COLOR_BACK, IDM_BACKCOLOR, &OnColorCommand)
	...
	DHTMLEDITING_CMD_ENTRY(ID_DENT_IN, IDM_INDENT)
	DHTMLEDITING_CMD_ENTRY(ID_DENT_OUT, IDM_OUTDENT)
...
void CSiteMakerView::OnColorCommand(UINT nIDM)
{
	int nValue;
