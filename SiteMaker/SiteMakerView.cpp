...
BEGIN_DHTMLEDITING_CMDMAP(CSiteMakerView)
	...
	DHTMLEDITING_CMD_ENTRY(ID_EDIT_PASTE_TEXT, IDM_PASTETEXTONLY)
	...
	DHTMLEDITING_CMD_ENTRY_FUNC(ID_COLOR_FORE, IDM_FORECOLOR, &OnColor)
	DHTMLEDITING_CMD_ENTRY_FUNC(ID_COLOR_BACK, IDM_BACKCOLOR, &OnColor)
	DHTMLEDITING_CMD_ENTRY(ID_FORMAT_FONT, IDM_FONT)
	DHTMLEDITING_CMD_ENTRY(ID_FORMAT_REMOVE, IDM_REMOVEFORMAT)
	DHTMLEDITING_CMD_ENTRY(ID_FORMAT_HYPERLINK, IDM_HYPERLINK)
	DHTMLEDITING_CMD_ENTRY(ID_FORMAT_UNLINK, IDM_UNLINK)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_JUSTIFY_LEFT, IDM_JUSTIFYLEFT, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_JUSTIFY_CENTER, IDM_JUSTIFYCENTER, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_JUSTIFY_RIGHT, IDM_JUSTIFYRIGHT, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_JUSTIFY_FULL, IDM_JUSTIFYFULL, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_JUSTIFY_NONE, IDM_JUSTIFYNONE, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_BLOCK_LTR, IDM_BLOCKDIRLTR, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_BLOCK_RTL, IDM_BLOCKDIRRTL, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_LIST_UNORDERED, IDM_UNORDERLIST, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_LIST_ORDERED, IDM_ORDERLIST, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY(ID_BLOCK_INDENT, IDM_INDENT)
	DHTMLEDITING_CMD_ENTRY(ID_BLOCK_OUTDENT, IDM_OUTDENT)
	DHTMLEDITING_CMD_ENTRY_FUNC_TYPE(ID_POSITION_STATIC, IDM_1D_ELEMENT, &OnPositionStatic, AFX_UI_ELEMTYPE_CHECBOX)
	DHTMLEDITING_CMD_ENTRY_FUNC_TYPE(ID_POSITION_ABSOLUE, IDM_2D_ELEMENT, &OnPositionAbsolute, AFX_UI_ELEMTYPE_CHECBOX)
	...
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_MARQUEE, IDM_MARQUEE)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_BUTTON, IDM_BUTTON)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_CHECK, IDM_CHECKBOX)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_RADIO, IDM_RADIOBUTTON)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_TEXTBOX, IDM_TEXTBOX)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_TEXTAREA, IDM_TEXTAREA)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_DROPDOWN, IDM_DROPDOWNBOX)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_LISTBOX, IDM_LISTBOX)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_IFRAME, IDM_IFRAME)
	DHTMLEDITING_CMD_ENTRY(ID_INSERT_FIELDSET, IDM_INSFIELDSET)
	...
	DHTMLEDITING_CMD_ENTRY_TYPE(ID_MODE_BROWSE, IDM_BROWSEMODE, AFX_UI_ELEMTYPE_RADIO)
...
void CSiteMakerView::OnColor(UINT nIDM)
{
	int nValue;
	ExecHelperGetVal(nIDM, nValue);
	CMFCColorDialog dlg(nValue);
	if (dlg.DoModal() == IDOK)
	{
		nValue = dlg.GetColor();
		ExecHelperSetVal(nIDM, nValue);
	}
}

void CSiteMakerView::OnPositionStatic(UINT)
{
	SetAbsolutePosition(false);
}

void CSiteMakerView::OnPositionAbsolute(UINT)
{
